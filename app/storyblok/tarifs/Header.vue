<template>
  <section
    v-editable="blok"
    class="relative pt-32 pb-20 bg-white overflow-hidden"
  >
    <!-- Éléments de fond (non éditable, pure déco) -->
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div class="absolute top-0 left-0 w-full h-64 opacity-15">
        <svg width="100%" height="100%" viewBox="0 0 1440 200" fill="none">
          <line
            ref="gridLine1"
            x1="0" y1="60" x2="1440" y2="60"
            stroke="#7FD857" stroke-width="1.5" opacity="0.4"
            stroke-dasharray="15 10" stroke-dashoffset="1440"
          />
          <line
            ref="gridLine2"
            x1="0" y1="100" x2="1440" y2="100"
            stroke="#7FD857" stroke-width="1.5" opacity="0.3"
            stroke-dasharray="15 10" stroke-dashoffset="1440"
          />
          <line
            ref="gridLine3"
            x1="0" y1="140" x2="1440" y2="140"
            stroke="#0F1729" stroke-width="1" opacity="0.2"
            stroke-dasharray="15 10" stroke-dashoffset="1440"
          />
        </svg>
      </div>
