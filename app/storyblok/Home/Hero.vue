...
onMounted(() => {
  ...
  if (trail1Ref.value) gsap.to(trail1Ref.value, { strokeDashoffset: 0, duration: 3, ease: 'power1.inOut', delay: 2.5 })
  if (trail2Ref.value) gsap.to(trail2Ref.value, { strokeDashoffset: 0, duration: 3, ease: 'power1.inOut', delay: 2.8 })
