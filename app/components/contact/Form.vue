<template>
	<div class="bg-white rounded-3xl shadow-2xl relative p-8 md:p-12 h-full flex flex-col justify-center overflow-hidden">
		...
		<h3 class="text-2xl font-bold text-[#0F1729] mb-10 relative z-10">Envoyer un message</h3>
